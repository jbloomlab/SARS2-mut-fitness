...
%DIF DEL paper_bioRxiv_v1.tex   Sat Jun  3 06:49:23 2023
%DIF ADD paper.tex              Sat Jun  3 15:05:24 2023
...
\DIFaddbegin \DIFadd{An important question is whether the mutation fitness estimates are affected by noise from limited statistical sampling of mutations even after aggregating across clades.
...
The nonstructural and structural proteins are essential, and these proteins show strong selection against stop codons and clear although variable purifying selection against amino-acid mutations (Figure~\ref{fig:dist}B \DIFaddbegin \DIFadd{and \ref{fig:effects_dist_positon_order}}\DIFaddend ; e.g., nsp13 is under stronger protein-level constraint than nsp1).

However, most accessory proteins are under little constraint (Figure~\ref{fig:dist}B \DIFaddbegin \DIFadd{and \ref{fig:effects_dist_positon_order}}\DIFaddend ).
