...
In doing this, we exclude any mutations that are not from the clade-founder amino-acid identity: in other words, we ignore sequences with histories that involve multiple amino-acid mutations at the same site in the same clade (this is a caveat of the approach, although because each clade is relatively high identity it does not have a major effect).
