...
The accessory proteins are all encoded in the last third of the SARS-CoV-2 genome, meaning that our results show that this portion of the genome (with the exception of the nucleocapsid gene) is under relatively weak purifying selection (Figure~\ref{fig:effects_dist_position_order}).
This finding is consistent with observations that the genes encoded in the last third of the genome vary across coronaviruses~\citep{v2021coronavirus,llanes2020betacoronavirus}, and are mostly dispensable in cell culture~\citep{mcgrath2022sars,silvas2021contribution,liu2022live,liu2014accessory}.
