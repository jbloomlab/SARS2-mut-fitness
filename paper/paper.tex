...
\subsection*{Mutation-effect estimates correlate with deep mutational scanning}

\begin{figure*}
\centering
\includegraphics[width=0.7\linewidth]{figs/dms.png}
\caption{
Correlation of amino-acid fitness estimates with experimental deep mutational scanning measurements for {\bf (A)} the full spike~\citep{dadonaite2022pseudovirus} or its receptor binding domain (RBD)~\citep{starr2022deep}, and {\bf (B)} Mpro (nsp5)~\citep{flynn2022,iketani2022functional}.
...
See \url{https://jbloomlab.github.io/SARS2-mut-fitness/dms_S_corr.html} and \url{https://jbloomlab.github.io/SARS2-mut-fitness/dms_nsp5_corr.html} for plots that enable subsetting on just mutations shared across all datasets and other interactive options.
\label{fig:dms_corr}
}
\end{figure*}
