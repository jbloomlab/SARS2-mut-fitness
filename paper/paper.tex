...
For spike, tractable laboratory assays have identified key functional and antigenic mutations~\citep{weisblum2020escape}, and enabled deep mutational scanning measurements of how most mutations affect receptor binding, cellular infection, and antibody recognition~\citep{starr2020deep,dadonaite2022pseudovirus,greaney2021complete,cao2022imprinted}.
...
But most other viral proteins lack comparably tractable laboratory assays, despite the fact that non-spike proteins clearly contribute to viral fitness~\citep{thorne2022evolution,syed2021rapid,mcgrath2022sars} and are the targets of efforts to develop anti-viral drugs~\citep{tao2021sars}.
...
We therefore first calculate the number of \emph{expected} occurrences of each mutation based on the neutral mutation spectrum of SARS-CoV-2 as estimated from four-fold degenerate synonymous sites~\citep{bloom2022evolution}.
...
The resulting estimates are used to create maps of mutation-level functional constraint across each viral protein, and correlate well with existing deep mutational scanning data.
