...
The overall distributions of mutation effects concur with biological intuition about how different classes of mutations impact protein function.
...
To investigate possible differences among viral proteins, we computed the distributions of effects separately for each gene (Figure~\ref{fig:dist}B).
...
The nonstructural proteins form the essential viral replication and transcript complex, and the structural proteins form the essential physical virion~\citep{v2021coronavirus}.
Consistent with their essentiality, all nonstructural and structural proteins show strong selection against stop codons, and clear although variable purifying selection against amino-acid mutations (Figure~\ref{fig:dist}B; e.g., nsp13 is under stronger protein-level constraint than nsp1).
...
The only accessory protein under strong purifying selection against premature stop codons is ORF3a (Figure~\ref{fig:dist}B), for which amino-acid mutations mostly have little effect but stop codons in the first ~240 residues are clearly deleterious effects (Figure~\ref{fig:ORF3a}).
These observations concur with experiments showing SARS-CoV-2 is attenuated in human-ACE2 mice by deletion of ORF3a but there is little effect of deleting ORF6, ORF7a, or ORF8~\citep{mcgrath2022sars,silvas2021contribution,liu2022live}.
Even ORF3a must perform functions that are relatively insensitive to its protein sequences, since there is little constraint beyond selection against stop codons in the first ~240 residues and a few important amino-acids at sites like 135 and 138 (Figure~\ref{fig:ORF3a}).
Observations such as these could help guide experimental and structural studies to understand protein function.
