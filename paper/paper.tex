...
This wide variation is because the SARS-CoV-2 mutation spectrum is highly biased towards specific mutation types~\citep{bloom2022evolution,ruis2022mutational,de2021mutation}.
However, as Figure~\ref{fig:expected_vs_actual}B shows, in the absence of selection we expect to observe multiple independent occurrences of all nucleotide mutations at each site. 
